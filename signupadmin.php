...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-display-bottomleft w3-padding-large w3-opacity">
    ...
    <h1 class="w3-xxxlarge w3-text-green"><b>To enter the UiTM Booking Studio System.</b></h1>
    <hr style="width:800px;border:2px solid green" class="w3-round">
  </div>

	<!--Form-->
	<form action="submitadmin.php" method="GET">
	<table>
	<tr>
		<td> Admin ID: </td>
	...
	<input type="submit" value="Submit" required>
		...
		<p>
			Already a member? <a href="loginadmin.php">Login</a>
		</p>
    </form>
