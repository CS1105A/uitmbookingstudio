...
<div class="w3-main" style="margin-left:340px;margin-right:40px">
  ...
  <div class="w3-display-bottomleft w3-padding-large w3-opacity">
    ...
    <h1 class="w3-xxxlarge w3-text-green"><b>To book the basic studio.</b></h1>
...
?>
	<tr>
		...
		<td>
		 <a href='updatestudbasic.php?id=<?php echo $row["id"];?>'> Edit </a> , 
		 <a href='confirmbasicdelete.php?id=<?php echo $row["id"];?>'> Delete </a>
		 </td>
	</tr>
...
?>
	...
	<br> <br> 
	<!--Form-->
	<form action="submitbookbasic.php" method="GET">
	<table>
